...
twitter_data.each do |data|
  data.each do |name, data_2|
    if data_2["description"].nil?
      data_2["description"] = "NA"
    end
    puts "#{name}: #{data_2["description"]}"
  end
end
puts
...
twitter_data.each do |data|
  data.each do |name, data_2|
    puts "#{name}: #{data_2["number of followers"]}"
  end
end
puts
...
twitter_data.each do |data|
  data.each do |name, data_2|
    puts "#{name}'s latest tweet was #{data_2["latest tweet"].length} characters long."
  end
end
puts
...
twitter_data.each do |data|
  data.each do |name, data_2|
    total_tweets_length = 0
      data_2["last twenty tweets"].each do |tweet|
        tweets_totals[name] = (total_tweets_length += tweet.length)
    end
  end
end

tweets_totals.each do |name, total_tweets_length|
  puts "#{name} used #{total_tweets_length} characters in their last twenty tweets."
end
puts
...
twitter_data.each do |data|
  data.each do |name, data_2|
    if data_2["number of followers"] > max
      max = data_2["number of followers"]
      most_followed = name
    end
  end
end

puts "#{most_followed} has the most followers at #{max}."
puts
...
twitter_data.each do |data|
  data.each do |name, data_2|
    if data_2["number of friends"] > max
      max = data_2["number of friends"]
      top_friendster = name
    end
  end
end

puts "#{top_friendster} has the most friends at #{max}."
puts
...
twitter_data.each do |data|
  data.each do |name, data_2|
    if data_2["number of tweets"] > max
      max = data_2["number of tweets"]
      top_tweeter = name
    end
  end
end

puts "#{top_tweeter} has the most tweets at #{max}."
puts

puts "These users have a description listed:"
...
puts "These users have a location listed:"
twitter_data.each do |data|
  data.each do |name, data_2|
    if !data_2["location"].nil?
      puts "* #{name} (#{data_2["location"]})."
    end
  end
end
